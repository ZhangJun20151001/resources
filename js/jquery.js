            ...
            case 'comment-insert-smilie':
            	if( !$('#comment-smilies').length ){
					...
					for( key in options.smilies ){
						res += '<img data-simle="'+key+'" data-type="comment-smilie" src="'+_deel.url+'/img/smilies/'+options.smilies[key]+'.gif">'
					}
